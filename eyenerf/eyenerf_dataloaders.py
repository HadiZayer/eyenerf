...
class CacheDataloader(DataLoader):
    ...
    def _get_batch_list(self):
        ...
        num_threads = 1 # hardcode for now because we don't have many images anyways 
        print(num_threads)

        # see if it's faster to not use this 
    ...
    def _get_collated_batch(self):
        ...
        collated_batch = get_dict_to_torch(
            collated_batch, device=self.device, exclude=["image", "mask"]
